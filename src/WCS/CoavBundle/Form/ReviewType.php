...
class ReviewType extends AbstractType
{
    ...
    /**
     * {@Si la requête est de type POST, ton objet $request (typé automatiquement) reçu en paramètre de fonction, contiendSi la requête est de type POST, ton objet $request (typé automatiquement) reçu en paramètre de fonction, contiendSi la requête est de type POST, ton objet $request (typé automatiquement) reçu en paramètre de fonction, contiendSi la requête est de type POST, ton objet $request (typé automatiquement) reçu en paramètre de fonction, contiendSi la requête est de type POST, ton objet $request (typé automatiquement) reçu en paramètre de fonction, contiendra tes données. - Si celui-ci est bien submit (en cra tes données. - Si celui-ci est bien submit (en cra tes données. - Si celui-ci est bien submit (en cra tes données. - Si celui-ci est bien submit (en cra tes données. - Si celui-ci est bien submit (en cinheritdoc} getName() is now deprecated
     */
